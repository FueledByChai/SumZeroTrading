...
public class ParadoxOrderStatusUpdateTest {
    ...
    public void testConstructor_ValidParameters_CreatesObjectSuccessfully() {
        // Act
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                cancelReasonString, averageFillPrice, orderType, side, timestamp);
    ...
    public void testConstructor_AllParadexOrderStatusValues() {
        // Test NEW status
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, "NEW",
                cancelReasonString, averageFillPrice, orderType, side, timestamp);
        assertEquals(ParadexOrderStatus.NEW, orderStatusUpdate.getStatus());

        // Test OPEN status
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, "OPEN",
                cancelReasonString, averageFillPrice, orderType, side, timestamp);
        assertEquals(ParadexOrderStatus.OPEN, orderStatusUpdate.getStatus());

        // Test CLOSED status
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, "CLOSED",
                cancelReasonString, averageFillPrice, orderType, side, timestamp);
    ...
    public void testConstructor_AllCancelReasonValues() {
        ...
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                "NONE", averageFillPrice, orderType, side, timestamp);
        assertEquals(CancelReason.NONE, orderStatusUpdate.getCancelReason());

        // Test POST_ONLY_WOULD_CROSS cancel reason
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                "POST_ONLY_WOULD_CROSS", averageFillPrice, orderType, side, timestamp);
        assertEquals(CancelReason.POST_ONLY_WOULD_CROSS, orderStatusUpdate.getCancelReason());

        // Test USER_CANCELED cancel reason
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                "USER_CANCELED", averageFillPrice, orderType, side, timestamp);
    ...
    public void testConstructor_InvalidCancelReason_DefaultsToNone() {
        // Act
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                "INVALID_REASON", averageFillPrice, orderType, side, timestamp);
    ...
    public void testConstructor_NullCancelReason_DefaultsToNone() {
        // Act
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                null, averageFillPrice, orderType, side, timestamp);
    ...
    public void testConstructor_EmptyCancelReason_DefaultsToNone() {
        // Act
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status, "",
                averageFillPrice, orderType, side, timestamp);
    ...
    public void testConstructor_AllOrderTypes() {
        ...
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                cancelReasonString, averageFillPrice, "MARKET", side, timestamp);
        assertEquals(OrderType.MARKET, orderStatusUpdate.getOrderType());

        // Test LIMIT order type
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                cancelReasonString, averageFillPrice, "LIMIT", side, timestamp);
        assertEquals(OrderType.LIMIT, orderStatusUpdate.getOrderType());

        // Test STOP order type
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                cancelReasonString, averageFillPrice, "STOP", side, timestamp);
    ...
    public void testConstructor_AllSides() {
        // Test BUY side
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                cancelReasonString, averageFillPrice, orderType, "BUY", timestamp);
        assertEquals(Side.BUY, orderStatusUpdate.getSide());

        // Test SELL side
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                cancelReasonString, averageFillPrice, orderType, "SELL", timestamp);
    ...
    public void testConstructor_InvalidOrderStatus_ThrowsException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, "INVALID_STATUS",
                    cancelReasonString, averageFillPrice, orderType, side, timestamp);
        });
    }
    ...
    public void testConstructor_InvalidOrderType_ThrowsException() {
        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> {
            new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status, cancelReasonString,
                    averageFillPrice, "INVALID_TYPE", side, timestamp);
        });
    }
    ...
    public void testConstructor_InvalidSide_ThrowsException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status, cancelReasonString,
                    averageFillPrice, orderType, "INVALID_SIDE", timestamp);
        });
    }
    ...
    public void testBigDecimalFields_HandlesNullValues() {
        // Act
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, null, null, status, cancelReasonString,
                null, orderType, side, timestamp);
    ...
    public void testTimestamp_HandlesZero() {
        // Act
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                cancelReasonString, averageFillPrice, orderType, side, 0);
    ...
    public void testTimestamp_HandlesNegativeValue() {
        ...
        // Act
        orderStatusUpdate = new ParadoxOrderStatusUpdate(tickerString, orderId, remainingSize, originalSize, status,
                cancelReasonString, averageFillPrice, orderType, side, negativeTimestamp);
    ...
    public void testTickerString_VariousFormats() {
        ...
        for (String ticker : tickers) {
            orderStatusUpdate = new ParadoxOrderStatusUpdate(ticker, orderId, remainingSize, originalSize, status,
                    cancelReasonString, averageFillPrice, orderType, side, timestamp);
    ...
    public void testPartiallyFilledOrder_Scenario() {
        ...
        // Act
        orderStatusUpdate = new ParadoxOrderStatusUpdate("BTC-USD", "partial123", partialRemaining, fullSize, "OPEN",
                "NONE", fillPrice, "LIMIT", "BUY", timestamp);
    ...
    public void testCanceledOrder_Scenario() {
        ...
        // Act
        orderStatusUpdate = new ParadoxOrderStatusUpdate("ETH-USD", "cancel456", remainingSize, originalSize, "CLOSED",
                "USER_CANCELED", averageFillPrice, "MARKET", "SELL", timestamp);
    ...
    public void testPostOnlyWouldCrossOrder_Scenario() {
        ...
        // Act
        orderStatusUpdate = new ParadoxOrderStatusUpdate("SOL-USD", "postonly789", originalSize, originalSize, "CLOSED",
                "POST_ONLY_WOULD_CROSS", BigDecimal.ZERO, "LIMIT", "BUY", timestamp);
