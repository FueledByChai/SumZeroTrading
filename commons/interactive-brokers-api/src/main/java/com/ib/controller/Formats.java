...
public class Formats {
	...
	private static final ThreadLocal<DateFormat> UTC_DATE_TIME_FORMAT_CACHE = ThreadLocal.withInitial(() -> {
	...
	public static String fmtDateUtc(long ms) {
		return UTC_DATE_TIME_FORMAT_CACHE.get().format(new Date(ms));
	}
